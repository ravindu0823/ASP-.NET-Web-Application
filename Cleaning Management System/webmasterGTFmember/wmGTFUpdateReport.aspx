<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wmGTFUpdateReport.aspx.cs" Inherits="webmasterGTFmember.wmGTFUpdateReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <form runat="server">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            ...
                                                            <asp:LinkButton ID="btnSave" runat="server" class="btn btn-secondary me-3" OnClick="btnSave_Click">Upload Image</asp:LinkButton>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <button type="button" class="btn btn-pill btn-success" onclick="UpdatePlace()">UPDATE PLACE</button>
                                                    </div>
                                                </div>
    ...
    <script defer>
        ...
        function UpdatePlace() {
            ...
            Place(place_name, situation, pathName, latitude, longitude, memberId, placeId);
        }

        function Place(placeName, situation, imagePath, lat, lng, addedBy, placeId) {
            $.ajax({
                type: "POST",
                url: "http://localhost:44362/CleaningService.svc/UpdatePlace",
                data: JSON.stringify({
                    "rEF_Place": {
                        PLACENAME: placeName,
                        SITUATION: situation,
                ...
                success: function (data) {
                    ...
                    var obj = JSON.parse(data.UpdatePlaceResult);
                    console.log(obj);
